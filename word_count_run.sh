...
hdfs dfs -rm -r $2
yarn jar /usr/local/hadoop/share/hadoop/tools/lib/hadoop-streaming*.jar -mapper $PWD/app/WordCountMapper.py \
  -reducer $PWD/app/WordCountReducer.py -input $1 -output $2
